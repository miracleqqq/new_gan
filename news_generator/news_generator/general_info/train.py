...
def train():
    ...
    with tf.Session() as session:
        ...
        for iteration in range(ITERS):
            ...
            for i in range(CRITIC_ITERS):
                ...
                batch_index += 1
                _disc_cost, _gen_cost,   _ = session.run(
            ...
            if iteration % 500 == 0:
                ...
                saver.save(session, 'trained_model_',global_step=iteration)
    ...
    def generate_samples():
        sc_gen, sc_disc, _data = data.get_next_batch(len(data._score_test), data._score_test, data._how_win_test, 0)
    ...
    one_dict = {}
    for i in range(100):
        sc_gen, sc_disc, _data = data.get_next_batch(len(test_1_score), test_1_score, how_win_1, 0)
